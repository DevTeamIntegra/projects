sap.ui.define(["sap/ui/core/mvc/Controller",
    ...
    "prestamosgp/model/models"
], function(BaseController, MessageBox, Utilities, History, Utils, models) {
	"use strict";

	return BaseController.extend("prestamosgp.controller.DetailVivienda", {
		...
		_onButtonPress: function(oEvent) {
			var oModel = models.getSimulacionVivienda(this.getEntries(), this.getOwnerComponent().oToken);
