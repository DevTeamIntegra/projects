sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("prestamosgp2.controller.MasterPage1", {
		...
		_onObjectListItemPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("DetailConsumo", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onObjectListItemPress4: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("DetailCotitular", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
