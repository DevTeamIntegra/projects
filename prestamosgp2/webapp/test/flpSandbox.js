		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PréstamosGP",
									"targetURL": "#prestamosgp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"prestamosgp2-display": {
								"semanticObject": "prestamosgp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=prestamosgp2",
									"url": sap.ui.require.toUrl("prestamosgp2")
								}
							}
						}
					}
